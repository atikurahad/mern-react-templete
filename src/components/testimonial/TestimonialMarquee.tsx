...
export default function TestimonialMarquee({
  ...
  const renderCard = (t: Testimonial) => (
    <div
      ...
      className="flex-shrink-0 w-[350px] md:w-[400px] bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300"
    >
  ...
  return (
    <div className="py-12 overflow-hidden w-full relative">
      ...
      <div className="absolute top-0 left-0 bottom-0 w-24 md:w-48 bg-gradient-to-r from-white via-white/75 to-transparent z-10 pointer-events-none" />
      <div className="absolute top-0 right-0 bottom-0 w-24 md:w-48 bg-gradient-to-l from-white via-white/75 to-transparent z-10 pointer-events-none" />
